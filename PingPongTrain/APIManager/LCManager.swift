...
class LCManager {
    ...
    func configure() {
        do {
            try LCApplication.default.set(
                id:  "DYwbNP9kSOaFh4g8qeD3C05u-gzGzoHsz",
                key: "oFf0iJynMkhF7EfOQMFxz9cR"
            )
        } catch {
            print("")
        }
    ...
    func saveGameRecord(_ team1: teamRecordModel, _ team2: teamRecordModel, _ quarter: Int, completion: @escaping (Bool, Error?) -> Void) {
        do {
            ...
            try todo.set("spin1", value: team1.Spin)
            try todo.set("spin2", value: team2.Spin)
            try todo.set("cut1", value: team1.Cut)
            try todo.set("cut2", value: team2.Cut)
            try todo.set("smash1", value: team1.Smash)
            try todo.set("smash2", value: team2.Smash)
            ...
            case .success(let result):
                ...
                for iii in 0..<todos.count {
                    ...
                    let team1 = teamRecordModel(
                        ...
                        Spin: todos[iii]["spin1"]!.intValue!,
                        Cut: todos[iii]["cut1"]!.intValue!,
                        Smash: todos[iii]["smash1"]!.intValue!,
                    ...
                    let team2 = teamRecordModel(
                        ...
                        Spin: todos[iii]["spin2"]!.intValue!,
                        Cut: todos[iii]["cut2"]!.intValue!,
                        Smash: todos[iii]["smash2"]!.intValue!,
