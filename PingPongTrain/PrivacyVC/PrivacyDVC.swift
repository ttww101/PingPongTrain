...
class PrivacyDVC: UIViewController, WKNavigationDelegate {
    ...
    init(dtitle:String, dUrl:[String]?) {
        super.init(nibName: nil, bundle: nil)
        self.modalPresentationStyle = UIModalPresentationStyle.overCurrentContext
        titleDesccnentt = dtitle
        if (dUrl != nil) {
            multiUrlcnentt = dUrl!
        }
    }
    ...
    func setDBack(emgker: String?, ortmw: String?, w4imgk3: String?, wegkp3: (() -> Void)?) {
        callbackcnentt = wegkp3
    }
