...
class TrainVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        listData = [
            ...
            TrainModel(title: "旋球训练", imageName: "spin", secondTitle: "Spin"),
            TrainModel(title: "削球训练", imageName: "cut", secondTitle: "Cut"),
            TrainModel(title: "杀球训练", imageName: "smash", secondTitle: "Smash")
        ]
